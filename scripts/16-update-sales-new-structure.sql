...
-- New columns: coffee_type, bag_type, batch_no, estate, bags_sent, kgs (auto-calc), kgs_received, bags_sold, price_per_bag, revenue (auto-calc), bank_account, notes

-- Add new columns (we'll keep old columns for now to preserve data)
ALTER TABLE sales_records 
ADD COLUMN IF NOT EXISTS coffee_type VARCHAR(50),
ADD COLUMN IF NOT EXISTS bag_type VARCHAR(50),
