    ...
    if (date) {
      ...
      if (result && Array.isArray(result) && result.length > 0) {
        ...
        const numericFields = [
          ...
          "fr_wp_percent",
          "dry_parch",
          "dry_parchment_todate",
          "wp_dp_percent",
          "dry_cherry",
          "dry_cherry_todate",
          "dry_cherry_percent",
          "dry_parchment_bags",
          "dry_parchment_bags_todate",
          "dry_cherry_bags",
...
export async function POST(request: NextRequest) {
  try {
    ...
    const record = {
      ...
      dry_parchment_todate: Number(data.dry_parchment_todate) || 0,
      ...
      dry_parchment_bags: Number(data.dry_parchment_bags) || 0,
      dry_parchment_bags_todate: Number(data.dry_parchment_bags_todate) || 0,
    ...
    const query = `
      INSERT INTO ${tableName} (
        ...
        wet_parchment, fr_wp_percent, dry_parch, dry_parchment_todate, wp_dp_percent,
        dry_cherry, dry_cherry_todate, dry_cherry_percent,
        dry_parchment_bags, dry_parchment_bags_todate, dry_cherry_bags, dry_cherry_bags_todate, notes
      )
      VALUES (
      ...
      DO UPDATE SET
        ...
        dry_parchment_todate = EXCLUDED.dry_parchment_todate,
        ...
        dry_parchment_bags = EXCLUDED.dry_parchment_bags,
        dry_parchment_bags_todate = EXCLUDED.dry_parchment_bags_todate,
    ...
    const result = await processingSql.query(query, [
      ...
      record.dry_parch,
      record.dry_parchment_todate,
      record.wp_dp_percent,
      record.dry_cherry,
      record.dry_cherry_todate,
      record.dry_cherry_percent,
      record.dry_parchment_bags,
      record.dry_parchment_bags_todate,
